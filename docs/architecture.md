...
В `src/main` лежит **69 классов / 6612 строк** в 20 пакетах, в `src/test` — **111 классов**
и 511 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **511 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
