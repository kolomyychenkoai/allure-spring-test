...
Документ проверен по шести линзам (числа, копии утверждений в других артефактах, внутренняя
согласованность, обещания-абсолюты, структура, тон) — по каждой один раз. Дальше правим его
при изменении кода или по находкам читателя, а не «ещё одним проходом»: данные пяти проходов
показали, что находки убывают внутри линзы и подскакивают при её смене, а правки сами
становятся источником дефектов.
