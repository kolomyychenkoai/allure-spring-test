...
В `src/main` лежит **69 классов / 7091 строк** в 20 пакетах, в `src/test` — **116 классов**
и 554 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **554 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
