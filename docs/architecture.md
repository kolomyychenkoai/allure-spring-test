...
В `src/main` лежит **69 классов / 7053 строк** в 20 пакетах, в `src/test` — **114 классов**
и 537 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **537 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
