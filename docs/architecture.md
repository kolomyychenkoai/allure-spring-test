...
Сам документ читается минут пятнадцать. Маршрут по коду из §2 занимает 1334 строку:
...
В `src/main` лежит **69 классов / 7000 строк** в 20 пакетах, в `src/test` — **113 классов**
