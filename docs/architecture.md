...
В `src/main` лежит **70 классов / 7357 строк** в 20 пакетах, в `src/test` — **118 классов**
и 575 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
Итого 1449 строка. Если времени мало, хватит шагов 1, 2 и 3: это 642 строки, и они дают
...
- **575 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
