...
В `src/main` лежит **69 классов / 7094 строк** в 20 пакетах, в `src/test` — **117 классов**
и 562 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
Итого 1329 строка. Если времени мало, хватит шагов 1, 2 и 3: это 633 строки, и они дают
...
- **562 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
