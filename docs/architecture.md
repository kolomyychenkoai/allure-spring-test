...
В `src/main` лежит **70 классов / 7321 строк** в 20 пакетах, в `src/test` — **118 классов**
...
| 6 | `internal/InstrumentationDiagnostics` | как видно, что перехват сломался: счётчики трансформаций и сбоев, выборка имён типов (дамп и гейт — на стороне тестов, см. §10) | 202 |

Итого 1413 строка. Если времени мало, хватит шагов 1, 2 и 3: это 642 строки, и они дают
