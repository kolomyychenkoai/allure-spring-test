...
В `src/main` лежит **69 классов / 6702 строк** в 20 пакетах, в `src/test` — **112 классов**
и 515 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **515 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
