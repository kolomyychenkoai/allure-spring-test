...
В `src/main` лежит **69 классов / 6744 строк** в 20 пакетах, в `src/test` — **113 классов**
и 525 тестов. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **525 тестов** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
