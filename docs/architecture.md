...
В `src/main` лежит **69 классов / 6494 строк** в 20 пакетах, в `src/test` — **108 классов**
и 504 теста. У клиентского проекта появляется ровно одна зависимость в `compile`
...
- **504 теста** в двух уровнях. Уровень A — детерминированные проверки содержимого отчёта
