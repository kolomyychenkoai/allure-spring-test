 ...
 * там JVM-флаги и переменные ОС, а не настройки приложения.
 * <p>
 * ⚠️ Значения НЕ маскируются: во вложение идут все свойства как есть, включая пароли и токены
 * из тестовой конфигурации. Отчёт с таким вложением — настолько же чувствительный артефакт,
