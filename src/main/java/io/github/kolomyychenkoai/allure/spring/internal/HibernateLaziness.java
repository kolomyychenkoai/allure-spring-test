 ...
 * <p>
 * <b>Стоимость ЗАМЕРЕНА</b> на полном сьюте: 2128 вызовов, 1,8 мс суммарно, 0,84 мкс на вызов.
 ...
 * <p>
 * ⚠️ <b>Защита Hibernate-СПЕЦИФИЧНА.</b> Распознаются только его интерфейсы; у потребителя
 * на EclipseLink или OpenJPA ленивое значение защиты НЕ получит, и прокси будет разбужен
 * рендером. Имена обоих интерфейсов стережёт канарейка
 * {@code canary/InstrumentationApiCanaryTest} — переименуют в Hibernate, узнаем точечно,
 * а не по возврату дефекта.
 */
