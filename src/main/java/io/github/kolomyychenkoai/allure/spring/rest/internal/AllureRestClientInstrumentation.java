 ...
 * package-private ВНУТРЕННИЙ класс Spring (НЕ публичный API), проверено на Spring 6.2 и 7.0.
 * Одной точки достаточно ровно потому, что реализация {@code RestClient.Builder} единственная.
