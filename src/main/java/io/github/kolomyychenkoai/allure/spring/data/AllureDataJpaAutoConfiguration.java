...
public class AllureDataJpaAutoConfiguration {
    ...
    private static final String NOTICE =
            "AspectJ-создателя прокси в контексте нет (авто-проксирование выключено или заменено "
                    ...
                    + "остаётся: его пишет отдельный канал, но окажется на верхнем уровне теста, "
                    + "а не внутри шага репозитория. Нужны шаги репозиториев — включите "
                    + "авто-проксирование (spring.aop.auto по умолчанию включено) либо заведите "
                    + "@EnableAspectJAutoProxy у себя. "
