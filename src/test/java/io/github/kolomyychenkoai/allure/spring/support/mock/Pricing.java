...
public interface Pricing {
    ...
    /**
     * Возвращает СУЩНОСТЬ. Заведено ради витрины ленивой связи: мок, отдающий ленивый
     * прокси, — реальный сценарий у потребителя ({@code @MockitoBean} на репозитории),
     * и без него защита Mockito-пути от пробуждения прокси была бы форвардной.
     */
    Object entity();
}
