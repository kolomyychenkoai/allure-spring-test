 ...
 * <p>
 * Именно этот случай нашла A/B-проверка на чужом сервисе, и до появления этого класса он
 * в репозитории не был закреплён ничем — жил только в сервисах-потребителях, которые вне git.
 */
@Service
