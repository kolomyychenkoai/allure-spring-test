...
class JUnitJupiterAssertionsReportIT {
    ...
    void everyHookedAssertionFamilyIsShowcased() {
        ...
        // Имя, которое перехватывается, но не вызывается витриной, не стережёт НИЧТО: сломайся
        // разбор именно этой перегрузки — ни один гейт не покраснеет. Тест держит витрину полной,
