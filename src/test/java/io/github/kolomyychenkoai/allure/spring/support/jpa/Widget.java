...
public class Widget extends BaseEntity {
    ...
    /**
     * ЛЕНИВАЯ связь — витрина для защиты {@code JpaLaziness}: аспект обязан напечатать
     * маркер, а не разбудить прокси лишним SELECT'ом. Без этого поля защита была бы форвардной
